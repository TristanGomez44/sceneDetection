...
def coverage(gt,pred):
    ...
    for i,scene in enumerate(gt):
        ...
        cov_gt_array[i] *= leng(scene)/(gt[-1,1])
...
def main(argv=None):
    ...
    if args.compt_gt_true_baseline:
        comptGT_trueBaseline(args.compt_gt_true_baseline[0],args.exp_id,args.dataset,args.compt_gt_true_baseline[1],args.frame)
