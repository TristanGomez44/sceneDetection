evalOneDataset () {
  ...
  python trainVal.py -c model.config --exp_id $1  --train_part_end 0 --dataset_val $2 --val_part_beg 0 \
                                     --epochs 63  --start_mode fine_tune --init_path ../models/holly2/modellstm_res50_holly2_epoch63   --model_id res50_lstm_Holly2_7

  python trainVal.py -c model.config --exp_id $1  --train_part_end 0 --dataset_val $2 --val_part_beg 0 \
                                     --epochs 41  --start_mode fine_tune --init_path ../models/holly2/modelres50_res50_holly2_epoch41  --model_id res50_res50_Holly2_7    --temp_model resnet50
